...
element.innerHTML = 'Aplicación creada por Ernesto Milá';

// Crear una clase denominada 'ToDo' cuyo constructor debe recibir un 
// único parámetro del tipo string
...
function buildToDos(toDos) {
  // Tu código acá:
  let result = toDos.map(function (toDos,index) {
    return buildToDo(toDos, index);
  })
  return result;
}
...
//   en pantalla
//  1) Seleccionr el elemento cuyo id es 'toDoContainer' y almacenarlo 
//  en una variable denominada 'toDoContainer'
...
// Todo Event Listener recibe como parámetro el objeto 'event' conteniendo 
// un montón de información que incluye
// el tipo del evento, que elemento fue el que lo llamó, los valores de 
// dicho elemento, etc.
// En este paso vamos a utilizarlo para encontrar el index del item 
// que disparó el evento (Esta parte ya se encuentra desarrollada pero está 
...
//   (Recuerden que habíamos creado dcho método en el
//      prototipo de la clase ToDo) sobre el elemento correspondiente del 
//   array toDoItems
//   2) Llamar a displayToDos para actualizar los elementos que 
//   se van a mostrar en pantalla
//   3) En la función 'buildToDo' agregar un 'click' event listener 
//   al elemento 'toDoText', pasándole esta función como callback
...
/*    Investigá sobre el tipo 'checkbox' del elemento input y realizar 
      lo siguiente en la función 'buildToDo':
        ...
        c) Agregarle al checkbox el 'click' event listener de 
           completeToDo y quitárle el event listener a toDoText
